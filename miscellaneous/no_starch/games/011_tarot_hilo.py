...
def setup_card_one():
    ...
    global CARD1_VAL
    get_rnd_card()
    CARD_ONE = NEW_CARD+".jpg" #card image filename
    CARD1_VAL = random_card #card number 1-14
    BUT1 = Button(FRAME1)
    PHOTO = ImageTk.PhotoImage(file='cardsb\\'+str(CARD_ONE))
...
def setup_card_two():
    ...
    BUT2 = Button(FRAME1)
    PHOTO2 = PhotoImage(file='cardsb\\blank.png')
...
def show_card_two():
    ...
    photo_2a = ImageTk.PhotoImage(file='cardsb\\'+str(NEW_CARD)+".jpg")
